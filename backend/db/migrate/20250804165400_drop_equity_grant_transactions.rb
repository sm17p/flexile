class DropEquityGrantTransactions < ActiveRecord::Migration[7.2]
  def up
    drop_table :equity_grant_transactions
    drop_enum :equity_grant_transactions_transaction_type
  end

  def down
    create_enum :equity_grant_transactions_transaction_type, %w[scheduled_vesting vesting_post_invoice_payment exercise cancellation manual_adjustment end_of_period_forfeiture]
