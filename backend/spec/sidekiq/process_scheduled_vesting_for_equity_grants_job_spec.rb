...
RSpec.describe ProcessScheduledVestingForEquityGrantsJob do
  describe "#perform" do
    ...
    let!(:equity_grant_vests_as_per_schedule2) { create(:equity_grant, :vests_as_per_schedule, vesting_schedule:, board_approval_date: 2.days.ago, period_ended_at: 1.day.ago) }
